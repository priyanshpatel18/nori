...
export const DEVNET_TOUR: TourStep[] = [
  ...
  },
  {
    ...
    body: "You'll need a sliver of SOL for transaction fees. The devnet faucet drops it once per wallet, straight to your address.",
  ...
  },
  {
    ...
    body: "You're set up. Choose a token, set the amount, paste a recipient. Nori generates a Groth16 proof in your browser before submitting.",
